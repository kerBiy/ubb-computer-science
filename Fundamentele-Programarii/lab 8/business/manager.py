...
class ManagerStudent:
    ...
    def delete(self, student_id: int) -> None:
        if not self.students.search_by_id(student_id):
    ...
    def search_by_id(self, student_id: int) -> str:
        student = self.students.search_by_id(student_id)
...
class ManagerSubject:
    ...
    def delete(self, subject_id: int) -> None:
        if not self.subjects.search_by_id(subject_id):
    ...
    def search_by_id(self, subject_id: int) -> tuple:
        subject = self.subjects.search_by_id(subject_id)
    ...
    def search_by_prof(self, professor: str) -> None:
        subject_list = self.subjects.search_by_prof(professor)
